...
export const ProductFooter = () => {
  return (
    <>
      <footer class="bg-neutral-900 text-center text-white flex-shrink-0">
        <div class="container px-6 pt-6 m-auto">
          <div class="mb-6 flex justify-center items-center">
            <a
              href="https://www.facebook.com/Blurridge/"
              target="_blank"
              rel="noreferrer"
              type="button"
            ...
            <a
              href="https://twitter.com/zachahalol"
              target="_blank"
              rel="noreferrer"
              type="button"
              class="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
            ...
            <a
              href="https://www.instagram.com/zachahalol/"
              target="_blank"
              rel="noreferrer"
              type="button"
              class="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
            ...
            <a
              href="https://github.com/blurridge/scanly-app"
              target="_blank"
              rel="noreferrer"
              type="button"
              class="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
